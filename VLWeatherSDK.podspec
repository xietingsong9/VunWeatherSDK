...
Pod::Spec.new do |s|
  s.name             = 'VLWeatherSDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of VLWeatherSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/xietingsong9/VLWeatherSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xietingsong9' => 'xietingsong3@163.com' }
  s.source           = { :git => 'https://github.com/xietingsong9/VLWeatherSDK.git', :tag => s.version.to_s }
